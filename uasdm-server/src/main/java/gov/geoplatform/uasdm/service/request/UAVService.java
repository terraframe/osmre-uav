...
@Service
public class UAVService implements CrudService
{
  ...
  @Request(RequestType.SESSION)
  public JSONArray bureaus(String sessionId)
  {
    return gov.geoplatform.uasdm.bus.Bureau.getOptions().stream().map(w -> w.toJSON()).collect(Collector.of(JSONArray::new, JSONArray::put, JSONArray::put));
  }
