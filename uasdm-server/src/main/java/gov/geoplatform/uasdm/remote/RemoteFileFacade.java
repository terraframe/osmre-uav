...
public class RemoteFileFacade
{
  ...
  public static void copyFolder(String sourceKey, String sourceBucket, String destKey, String destBucket)
  {
    service.copyFolder(sourceKey, sourceBucket, destKey, destBucket);
  }
