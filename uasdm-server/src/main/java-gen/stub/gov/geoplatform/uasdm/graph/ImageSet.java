...
public class ImageSet extends ImageSetBase
{
  ...
  {
    final List<UasComponent> parents = this.getParents(EdgeType.COMPONENT_HAS_IMAGE_SET, UasComponent.class);
  ...
  {
    return this.getChildren(EdgeType.IMAGE_SET_HAS_DOCUMENT, DocumentIF.class);
  }
  ...
  public void apply(UasComponentIF component)
  {
    ...
    {
      MdVertexDAOIF mdVertex = MdVertexDAO.getMdVertexDAO(ImageSet.CLASS);
      MdAttributeDAOIF mdAttribute = mdVertex.definesAttribute(ImageSet.NAME);
    ...
    if (isNew)
    {
      this.addParent((UasComponent) component, EdgeType.COMPONENT_HAS_IMAGE_SET).apply();
    }
  }
  ...
  public static ImageSet createIfNotExist(UasComponentIF uasComponent, CreateImageSetView view)
  {
    ...
    documents.stream() //
        ...
        .forEach(document -> set.addChild(document, EdgeType.IMAGE_SET_HAS_DOCUMENT).apply());

    return set;
  }

  public static Optional<ImageSet> find(UasComponentIF component, String name)
  {
    ...
    final GraphQuery<ImageSet> query = new GraphQuery<ImageSet>(statement.toString());
  ...
  public static List<ComponentImageSet> getAll(CollectionCriteria criteria)
  {
