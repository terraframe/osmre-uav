 ...
 */
public abstract class SensorBase extends com.runwaysdk.business.Business
{
  ...
  public static SensorQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SensorQuery query = new SensorQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (Sensor) com.runwaysdk.business.Business.get(oid);
  }
  
  public static Sensor getByKey(String key)
  {
    return (Sensor) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static Sensor lock(java.lang.String oid)
  {
    Sensor _instance = Sensor.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static Sensor unlock(java.lang.String oid)
  {
    Sensor _instance = Sensor.get(oid);
    _instance.unlock();
