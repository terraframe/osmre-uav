...
@com.runwaysdk.business.ClassSignature(hash = 1627224185)
/**
...
public abstract class CollectionUploadEventBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = 1627224185;
  ...
  {
    return (CollectionUploadEvent) com.runwaysdk.business.Business.get(oid);
  }
  
  public static CollectionUploadEvent getByKey(String key)
  {
    return (CollectionUploadEvent) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static CollectionUploadEvent lock(java.lang.String oid)
  {
    CollectionUploadEvent _instance = CollectionUploadEvent.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static CollectionUploadEvent unlock(java.lang.String oid)
  {
    CollectionUploadEvent _instance = CollectionUploadEvent.get(oid);
    _instance.unlock();
