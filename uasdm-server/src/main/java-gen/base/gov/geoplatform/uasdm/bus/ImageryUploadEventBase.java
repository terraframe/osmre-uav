...
@com.runwaysdk.business.ClassSignature(hash = 905487403)
/**
 ...
 */
public abstract class ImageryUploadEventBase extends com.runwaysdk.business.Business
{
  public final static String CLASS = "gov.geoplatform.uasdm.bus.ImageryUploadEvent";
  ...
  private static final long serialVersionUID = 905487403;
  
  public ImageryUploadEventBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(gov.geoplatform.uasdm.bus.ImageryUploadEvent.CLASS);
  ...
  public static ImageryUploadEvent get(String oid)
  {
    return (ImageryUploadEvent) com.runwaysdk.business.Business.get(oid);
  }
  
  public static ImageryUploadEvent getByKey(String key)
  {
    return (ImageryUploadEvent) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ImageryUploadEvent lock(java.lang.String oid)
  {
    ImageryUploadEvent _instance = ImageryUploadEvent.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static ImageryUploadEvent unlock(java.lang.String oid)
  {
    ImageryUploadEvent _instance = ImageryUploadEvent.get(oid);
    _instance.unlock();
