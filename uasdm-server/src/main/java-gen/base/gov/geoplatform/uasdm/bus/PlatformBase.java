 ...
 */
public abstract class PlatformBase extends com.runwaysdk.business.Business
{
  ...
  public static final long serialVersionUID = -472245343;
  ...
  public static PlatformQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    PlatformQuery query = new PlatformQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (Platform) com.runwaysdk.business.Business.get(oid);
  }
  
  public static Platform getByKey(String key)
  {
    return (Platform) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static Platform lock(java.lang.String oid)
  {
    Platform _instance = Platform.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static Platform unlock(java.lang.String oid)
  {
    Platform _instance = Platform.get(oid);
    _instance.unlock();
