...
@com.runwaysdk.business.ClassSignature(hash = 287700410)
public abstract class WorkflowActionDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = 287700410;
  ...
  */
  ...
  public gov.geoplatform.uasdm.bus.WorkflowTaskDTO getWorkflowTask()
  {
    ...
    {
      return gov.geoplatform.uasdm.bus.WorkflowTaskDTO.get(getRequest(), getValue(WORKFLOWTASK));
    }
  }
  ...
  public void setWorkflowTask(gov.geoplatform.uasdm.bus.WorkflowTaskDTO value)
  {
    if(value == null)
    {
