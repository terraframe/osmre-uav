...
### Features
 ...
 - **help** organization-specific, user-editable help pages   ([bce16](https://github.com/terraframe/osmre-uav/commit/bce16e13c6b0b40cc04ba8fe7bb73af4dabd92be))
 - support for viewing and managing image sets   ([ea98d](https://github.com/terraframe/osmre-uav/commit/ea98d9709cfff0eba3b447347d5408fc1ab40a6b))
 - added support for marking collections as having PII concerns   ([40ff0](https://github.com/terraframe/osmre-uav/commit/40ff06c73c6ef2f717e233a55202f615acbff807))
 ...
 - upgrade to aws sdk v2   ([32b67](https://github.com/terraframe/osmre-uav/commit/32b67e32431509f02bb20e11101a80807759ff4f))
...
### Bug Fixes
   ...
   - uasdm-server/pom.xml to reduce vulnerabilities The following vulnerabilities are fixed with an upgrade:- https://snyk.io/vuln/SNYK-JAVA-SOFTWAREAMAZONAWSSDK-15810116  ([1db98](https://github.com/terraframe/osmre-uav/commit/1db98222baa2e5798cccc13ccf6935c5650252a1))
   - uasdm-server/pom.xml to reduce vulnerabilities The following vulnerabilities are fixed with an upgrade:- https://snyk.io/vuln/SNYK-JAVA-SOFTWAREAMAZONAWSSDK-15810116  ([7e43e](https://github.com/terraframe/osmre-uav/commit/7e43e25c2025058a85f46578d76743be03a65601))
   - **processing** unspecified error on store (max s3 file upload size)   ([67e4d](https://github.com/terraframe/osmre-uav/commit/67e4df4a8cc208fb1f3df9cd5722d3d084ebc0ff))
   - **processing** connection timeout when getting job status in high concurrency situations  ([2ada6](https://github.com/terraframe/osmre-uav/commit/2ada6f4bd60be27d6bd14cb65888c1e1e493b9f4))
   - fixed bug when searching for sensors in the site filter   ([c74bb](https://github.com/terraframe/osmre-uav/commit/c74bb5f5c684d2399b4f43e1672b85ba461ce5ea))
   - **upload** improve upload complete message and fix tasks link   ([e300d](https://github.com/terraframe/osmre-uav/commit/e300d84eb56b66b715295e115c78c10d0d2755d7))
   - **collection** collections would sometimes not show all raw   ([efad0](https://github.com/terraframe/osmre-uav/commit/efad04e889a5463c080edb9ded0fba95b449ae5c))
   - **tasks** clean up jobs stuck in processing for too long   ([89556](https://github.com/terraframe/osmre-uav/commit/89556807abd35abf0cd214113edc3c737df599f7))
   - **processing-report** raw image count doesn't match expected   ([1970f](https://github.com/terraframe/osmre-uav/commit/1970f9cf5836c5f9bc4e04e8b2fa349bf3c69680))
   - **upload** files that failed validation were still being uploaded to raw  ([deff3](https://github.com/terraframe/osmre-uav/commit/deff371f2fe3f44149d14e25908700848fc22ace))
   - Collection report 'number of products' counts product groups   ([7b09a](https://github.com/terraframe/osmre-uav/commit/7b09a8ed507d12d014cd179cc0e5be2c8509b33a))
   - **processing** RX1R2 geofile always fails with 'expected 4 columns'   ([30e00](https://github.com/terraframe/osmre-uav/commit/30e009b29acb1a6fc5deeae93abb4624620ff0a6))
   - **processing** unable to select a geo location or gcp file   ([ed75d](https://github.com/terraframe/osmre-uav/commit/ed75d9782819d51e595025c254e296402dc34644))
   - **map** mapping products with 'ortho' in the name causes confusion   ([ddb29](https://github.com/terraframe/osmre-uav/commit/ddb29656f493c6e1ff476d9e5aa33055ff4892e0))
   ...
   - issue where processing files could pile up and cause the server to run out of disk space  ([c98a6](https://github.com/terraframe/osmre-uav/commit/c98a655867897578fbfd0706ff1b831631ed9b16))
   - ability to delete projects   ([47ffe](https://github.com/terraframe/osmre-uav/commit/47ffe0bca7b1a280f1b0855b6958c0d57fcd29dd))
   - fix for NPE when deleting existing artifacts during a manual upload   ([b753e](https://github.com/terraframe/osmre-uav/commit/b753e17bd86f54ff427417e5bd39ddb7e38b7fbb))
   - patcher for stale collection report data which was not updated due to a bug  ([7a1d6](https://github.com/terraframe/osmre-uav/commit/7a1d6435555fcb12efa1088891b8877f00746b7b))
   - fixed issue where the collection report was not being updated because the update thread was being shutdown right after the webapplication started  ([73c0c](https://github.com/terraframe/osmre-uav/commit/73c0cdee313d1d5cc989b9648a4f6a172e4029f5))
   - fixed issue when viewing all of the products located within a hierarchy location the products were not restricted to the organizationof the hierarchy  ([e603d](https://github.com/terraframe/osmre-uav/commit/e603db1d0b440158c3cc60ea043471faf21b272f))
   - uasdm-server/pom.xml to reduce vulnerabilities The following vulnerabilities are fixed with an upgrade:- https://snyk.io/vuln/SNYK-JAVA-COMFASTERXMLJACKSONCORE-3038424- https://snyk.io/vuln/SNYK-JAVA-COMFASTERXMLJACKSONCORE-3038426  ([cc3af](https://github.com/terraframe/osmre-uav/commit/cc3afd89fcaf1803f5a0991e33092cb7e9ea129c))
...
## [1.8.1](https://github.com/terraframe/osmre-uav/releases/tag/1.8.1) (2026-03-30)
...
## [1.8.0](https://github.com/terraframe/osmre-uav/releases/tag/1.8.0) (2026-03-26)
...
## [1.7.0](https://github.com/terraframe/osmre-uav/releases/tag/1.7.0) (2026-02-10)
