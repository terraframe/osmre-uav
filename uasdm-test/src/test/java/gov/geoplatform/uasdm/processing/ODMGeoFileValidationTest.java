...
public class ODMGeoFileValidationTest
{
  ...
  /*
   * @Test(expected = GeoLocationFileInvalidFormatException.class) public void
   * testValidateMissingFile() { ODMProcessingPayload payload = new
   * ODMProcessingPayload(new CloseableFile(""));
   * 
   * payload.addImage("DSC00001.jpg", 10L); payload.addImage("DSC00002.jpg",
   * 10L); payload.addImage("DSC00003.jpg", 10L);
   * 
   * payload.
   * setGeoLocationFile("DSC00001.jpg 47.6537057 -092.5672988 0589.32\nDSC00002.jpg 47.6537057 -092.5672988 0589.32"
