...
//    collection.uploadArchive(new File("C:/Users/admin/Documents/TerraFrame/OSMRE/OSMRE.zip"));
//    
...
//  }
  ...
  public void testTarGzArchive()
  {
    ...
    Collection collection = Collection.get(collectionId1);
    collection.uploadArchive(new File("C:/Users/admin/Documents/TerraFrame/OSMRE/OSMRE.tar.gz"));
